...
const POINTS = [
  {
    id: 1,
    name: "Playa de Vice City",
    coords: [25.76, -80.19] as [number, number],
    desc: "Vista icónica del atardecer en la playa con palmeras, rascacielos al fondo y el océano reflejando las luces de la ciudad. Tráiler 1 — Escena inicial.",
  },
  {
    id: 2,
    name: "Pantanos de Leonida",
    coords: [25.5, -80.55] as [number, number],
    desc: "Toma aérea de pantanos extensos con vegetación densa, caimanes y una atmósfera misteriosa. Tráiler 1 — Secuencia de vida salvaje.",
  },
  {
    id: 3,
    name: "Estación de Servicio",
    coords: [25.68, -80.38] as [number, number],
    desc: "Ladrón encapuchado robando en una gasolinera con iluminación neón. Tráiler 1 — Escena de crimen callejero.",
  },
]
...
export default function MapaPage() {
  ...
  useEffect(() => {
    if (mapRef.current && !mapInstance.current) {
      ...
      import("leaflet").then((L) => {
        ...
        L.imageOverlay(
          "https://placehold.co/1200x800/0a0a0f/ff007f?text=Mapa+Conceptual+GTA+VI",
          bounds,
          { opacity: 1 },
        ).addTo(map)
  ...
  return (
    <div className="relative" style={{ height: "calc(100vh - 96px)", marginTop: "96px" }}>
